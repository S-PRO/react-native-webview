...
var WebView = /** @class */ (function (_super) {
    ...
    WebView.prototype.render = function () {
        var _a = this.props, onMessage = _a.onMessage, onShouldStartLoadWithRequestProp = _a.onShouldStartLoadWithRequest, originWhitelist = _a.originWhitelist, renderError = _a.renderError, renderLoading = _a.renderLoading, source = _a.source, style = _a.style, alphaEnabled = _a.alphaEnabled, _b = _a.nativeConfig, nativeConfig = _b === void 0 ? {} : _b, otherProps = __rest(_a, ["onMessage", "onShouldStartLoadWithRequest", "originWhitelist", "renderError", "renderLoading", "source", "style", "alphaEnabled", "nativeConfig"]);
        var otherView = null;
        ...
        source={resolveAssetSource(source)} style={webViewStyles} {...nativeConfig.props} alphaEnabled={alphaEnabled}/>);
